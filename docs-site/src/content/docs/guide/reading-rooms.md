---
title: Reading rooms
description: Read a shared list of articles alongside other people, in public.
---
...
![The Rooms page: an explainer, the open box, then Your rooms, Where people you follow are reading, and Featured rooms, each row with its reading-along count](../../../assets/screenshots/rooms.png)
...
![A room page: title and description, four readers' avatars with "4 reading along", the Join room button, and articles each marked with how many read it](../../../assets/screenshots/room.png)
