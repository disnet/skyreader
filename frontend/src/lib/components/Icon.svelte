<script lang="ts">
  ...
  let { name, size = 18, strokeWidth = 1.75 }: Props = $props();
</script>
...
>
  ...
  {:else if name === 'send'}
    ...
    <path d="M22 2 11 13" />
  {:else if name === 'semble'}
    <g transform="translate(0, -1) scale({24 / 32}, {24 / 43})" stroke="none">
      <path
  ...
  {:else if name === 'margin'}
    <g transform="translate(0, -0.5) scale({24 / 265}, {24 / 231})">
      <path
        d="M0 230 V0 H199 V65.7156 H149.5 V115.216 H182.5 L199 131.716 V230 Z"
        fill="#027bff"
        stroke="none"
      />
      <path
        d="M215 214.224 V230 H264.5 V0 H215 V16.2242 H248.5 V214.224 H215 Z"
        fill="#027bff"
        stroke="none"
      />
    </g>
  ...
  {:else if name === 'bluesky'}
    <path
      d="M5.5 4.5c2.2 1.7 4.6 5.1 5.5 6.9.9-1.8 3.3-5.2 5.5-6.9 1.6-1.2 4.1-2.1 4.1.8 0 .6-.3 4.9-.5 5.6-.7 2.4-3.1 3-5.3 2.6 3.8.7 4.8 2.8 2.7 4.9-3.9 4-5.6-1-6-2.3-.1-.2-.2-.4-.2-.5 0 .1-.1.3-.2.5-.4 1.3-2.1 6.3-6 2.3-2.1-2.1-1.1-4.2 2.7-4.9-2.2.4-4.6-.2-5.3-2.6-.2-.7-.5-5-.5-5.6 0-2.9 2.5-2 4.1-.8z"
      fill="currentColor"
      stroke="none"
    />
  {:else if name === 'standard-site'}
    <g transform="scale({24 / 28})">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
